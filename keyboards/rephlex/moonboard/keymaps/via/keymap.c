...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_iso(
        ...
        _______,   _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    QK_RGB_MATRIX_VALUE_DOWN,    QK_RGB_MATRIX_VALUE_UP,    QK_RGB_MATRIX_TOGGLE,    QK_RGB_MATRIX_HUE_UP,    QK_RGB_MATRIX_MODE_NEXT, _______,
        _______,   _______,    _______,                      _______,                                 _______, _______,    _______,    QK_RGB_MATRIX_SPEED_DOWN, QK_RGB_MATRIX_MODE_PREVIOUS, QK_RGB_MATRIX_SPEED_UP
        )
};
